...
(function () {
  ...
  const EXTRA = {
    ...
    'ملخص الجلسة': { ar:'ملخص الجلسة', en:'Session summary', fr:'Résumé de session' },
    'جلسة مستقرة': { ar:'جلسة مستقرة', en:'Stable session', fr:'Session stable' },
    'تم إنهاء الجلسة وحفظ ملخصها.': { ar:'تم إنهاء الجلسة وحفظ ملخصها.', en:'The session ended and its summary was saved.', fr:'La session est terminée et son résumé a été enregistré.' },
    'المدة': { ar:'المدة', en:'Duration', fr:'Durée' },
    'الإنذارات': { ar:'الإنذارات', en:'Alarms', fr:'Alertes' },
    'زمن الإنذار': { ar:'زمن الإنذار', en:'Alarm time', fr:"Temps d'alerte" },
    'أدنى EAR': { ar:'أدنى EAR', en:'Minimum EAR', fr:'EAR minimum' },
    'عرض السجل': { ar:'عرض السجل', en:'View history', fr:"Voir l'historique" },
    'إغلاق': { ar:'إغلاق', en:'Close', fr:'Fermer' },
    'تصدير التقرير': { ar:'تصدير التقرير', en:'Export report', fr:'Exporter le rapport' },
    'حرج': { ar:'حرج', en:'Critical', fr:'Critique' },
    'مرتفع': { ar:'مرتفع', en:'High', fr:'Élevé' },
    'متوسط': { ar:'متوسط', en:'Moderate', fr:'Modéré' },
    'منخفض': { ar:'منخفض', en:'Low', fr:'Faible' },
    'آمن': { ar:'آمن', en:'Safe', fr:'Sûr' },
    'البحث في الجلسات...': { ar:'البحث في الجلسات...', en:'Search sessions...', fr:'Rechercher des sessions...' },
    'فلترة مستوى الخطر': { ar:'فلترة مستوى الخطر', en:'Filter risk level', fr:'Filtrer le niveau de risque' },
    'كل المستويات': { ar:'كل المستويات', en:'All levels', fr:'Tous les niveaux' },
    'الأحدث أولاً': { ar:'الأحدث أولاً', en:'Newest first', fr:'Plus récentes' },
    'الأقدم أولاً': { ar:'الأقدم أولاً', en:'Oldest first', fr:'Plus anciennes' },
    'أعلى خطر': { ar:'أعلى خطر', en:'Highest risk', fr:'Risque le plus élevé' },
    'أطول جلسة': { ar:'أطول جلسة', en:'Longest session', fr:'Session la plus longue' },
    'أكثر إنذارات': { ar:'أكثر إنذارات', en:'Most alarms', fr:'Plus d’alertes' },
    '12 جلسة': { ar:'12 جلسة', en:'12 sessions', fr:'12 sessions' },
    '30 جلسة': { ar:'30 جلسة', en:'30 sessions', fr:'30 sessions' },
    'لا توجد جلسات تطابق الفلترة.': { ar:'لا توجد جلسات تطابق الفلترة.', en:'No sessions match the current filters.', fr:'Aucune session ne correspond aux filtres actuels.' },
    'تمت المعايرة': { ar:'تمت المعايرة', en:'Calibration complete', fr:'Calibration terminée' },
    'تم حفظ نتيجة المعايرة محلياً للاطلاع فقط.': { ar:'تم حفظ نتيجة المعايرة محلياً للاطلاع فقط.', en:'The calibration result was saved locally for reference only.', fr:'Le résultat de calibration est enregistré localement à titre informatif.' },
    'جاري المعايرة': { ar:'جاري المعايرة', en:'Calibrating', fr:'Calibration en cours' },
    'معايرة نشطة': { ar:'معايرة نشطة', en:'Adaptive profile active', fr:'Profil adaptatif actif' },
    'آخر معايرة': { ar:'آخر معايرة', en:'Last calibration', fr:'Dernière calibration' },
    'حافظ على فتح العينين وثبات الوجه أثناء المعايرة.': { ar:'حافظ على فتح العينين وثبات الوجه أثناء المعايرة.', en:'Keep your eyes open and face steady during calibration.', fr:'Gardez les yeux ouverts et le visage stable pendant la calibration.' },
    'بدء المعايرة': { ar:'بدء المعايرة', en:'Start calibration', fr:'Démarrer la calibration' },
    'الحالة': { ar:'الحالة', en:'Status', fr:'État' },
    'العينات': { ar:'العينات', en:'Samples', fr:'Échantillons' },
    'العتبة الحالية': { ar:'العتبة الحالية', en:'Current threshold', fr:'Seuil actuel' },
    'آخر معايرة': { ar:'آخر معايرة', en:'Last calibration', fr:'Dernière calibration' },
    'التبديل إلى الوضع الداكن': { ar:'التبديل إلى الوضع الداكن', en:'Switch to dark mode', fr:'Passer au mode sombre' },
    'التبديل إلى الوضع الفاتح': { ar:'التبديل إلى الوضع الفاتح', en:'Switch to light mode', fr:'Passer au mode clair' },
